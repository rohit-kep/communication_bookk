...
function Contact(props) {
    ...
    return (
        <div className=" hover:bg-red-300 w-full  px-[.6em] max-[375px]:px-[1em] p-[.9em]  flex items-center gap-[1em] max-[375px]:gap-[.5em] cursor-pointer" onClick={handleClick}>
            ...
            <p className="  text-[.9em] text-slate-300">last message goes here</p>
            <span className=" absolute w-[10px] h-[10px] rounded-full bg-red-400 right-[0]  bottom-[0]"></span>
            <p></p>
            </div>
